...
const SECTIONS = [
  ...
  },
  {
    title: 'View & output',
    items: [
      ['Floors', 'When the brief uses levels, the ▤ Floors menu switches between all floors together, one floor at a time, or the floor plans as flat isometric planes — stacked apart (offset), or overlaid on the same plane to compare footprints. Stacked views are read-only — pick a single floor to edit.'],
